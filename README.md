...
[![NPM version](<https://img.shields.io/npm/v/propraven.svg?label=npm%20(stable)>)](https://npmjs.org/package/propraven) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/propraven)
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/propraven-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install propraven`
...
```ts
import Propraven from 'npm:propraven';
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/propraven-typescript/issues) with questions, bugs, or suggestions.
